...
Gem::Specification.new do |spec|
  ...
  spec.description    =  %q{MoxiWorks Platform Client Library For Ruby. Partners can use the MoxiWorks Platform Library to quickly integrate into the MoxiWorks Platform}
  spec.summary       = %q{Ruby MoxiWorks Platform Client}
